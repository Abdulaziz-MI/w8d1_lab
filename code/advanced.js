...
const northernIrelandKeys = Object.keys(northernIreland);
...
countryPopulations = [scotland.population, england.population, wales.population, northernIreland.population]
countryPopulations.sort()
// console.log(countryPopulations);


for (let index = 0; index < countryPopulations.length; index++) {
  const population = countryPopulations[index];

  if (scotland.population === population){
  console.log( "scotland is the ", index, " biggest of the population");
}
}
